...
HOST_SAVE_DIR="$PROJECT_ROOT/results"
HOST_SAVE_PATH="$HOST_SAVE_DIR/$FILENAME"

CONTAINER_WRITE_PATH="$CONTAINER_DATA_DIR/$FILENAME"

mkdir -p "$HOST_SAVE_DIR"
echo "--- Host output directory created: $HOST_SAVE_DIR ---"

DOCKER_VOLUME_ARG="-v \"$HOST_SAVE_PATH\":\"$CONTAINER_WRITE_PATH\""
